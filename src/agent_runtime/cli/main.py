...
from agent_runtime.cli.commands.chat import cmd_chat
from agent_runtime.cli.commands.core import cmd_core_start, cmd_core_status, cmd_core_stop
from agent_runtime.cli.commands.ping import cmd_ping
from agent_runtime.cli.commands.run import cmd_run
from agent_runtime.cli.commands.trace import cmd_trace
from agent_runtime.cli.commands.version import cmd_version
...
def main() -> None:
    parser = argparse.ArgumentParser(prog="agentrt", description="Agent Runtime Kit CLI")
